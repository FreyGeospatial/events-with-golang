...
var kafkaTopic string = "bedaig-topic" // building event driven applications in go
...
func main() {
	...
	defer publisher.Close() // doesnt get run until the program exits
	// It's good practice to use defer immediately after creating the producer, so as not to forget to close it.

	// Delivery report handler
	go func() {
		// checks status of the message delivery
